@extends('trabajadores.master')
  ...
  @section('controller','recuperarAdministradores')
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <div class="card-image resaltar">
                  <img onerror="this.src='{{ url('img/logo-example.png') }}'" style="width: 240px !important; height: 101px !important;" class="profile-image logoCompany text-center" src="{{ url('img/Conecta6-logotipo.png') }}">
                </div>
