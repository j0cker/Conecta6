                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-key"></i> {{ Lang::get('messages.textoEmpresasPerfilModificarContrasena') }}
                                <small>
                                </small>
                            </h1>
                        </div>
                                ...
                                <div id="panel-1" class="panel panel-locked panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                    ...
                                    <div class="panel-hdr">
                                        <h2 class="ui-sortable-handle">
                                            {{ Lang::get('messages.textoEmpresasPerfilModificarContrasena') }}
                                        </h2>
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 25px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                    ...
                                                                    {{ Lang::get('messages.textoEmpresasPerfilContrasenaActual') }}:
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                    ...
                                                                    <input id="contActual" type="password" class="form-control" placeholder="{{ Lang::get('messages.textoEmpresasPerfilContrasenaActual') }}" />
                                                        ...
                                                        <div style="margin-top: 25px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                    ...
                                                                    {{ Lang::get('messages.textoEmpresasPerfilContrasenaNueva') }}:
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                    ...
                                                                    <input id="contNueva" type="password" class="form-control" placeholder="{{ Lang::get('messages.textoEmpresasPerfilNuevaContrasena') }}" />
                                                        ...
                                                        <div style="margin-top: 25px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                    ...
                                                                    {{ Lang::get('messages.textoEmpresasPerfilConfirmarContrasenaNueva') }}:
                                                        ...
                                                        <div class="col-md-4"></div>
                                                            ...
                                                            <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                ...
                                                                <input id="contConf" type="password" class="form-control" placeholder="{{ Lang::get('messages.textoEmpresasPerfilConfirmarNuevaContrasena') }}" />
                                                        ...
                                                        <div style="margin-top: 25px; margin-bottom: 25px;" class="row text-center">
                                                            <div class="col-12 text-center">
                                                                <a ng-click="postContChangeClick('{{ $user['usr']->pass }}', '{{ $user['usr']->id_empresas }}');" style="width: 200px;" href="#" class="btn btn-primary btn-block waves-effect waves-themed">{{ Lang::get('messages.textoEmpresasPerfilModificar') }}</a>
                                                            </div>
                                                        </div>
