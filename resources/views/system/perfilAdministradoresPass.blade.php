...
-->
@section('menuActive','perfilAdministradores')
...
@section('raiz3Url','/perfilAdministradores/pass')


{{-- Angular Controller --}}

@section('controller','perfilAdministradoresPass')
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 25px; margin-bottom: 25px;" class="row text-center">
                                                            <div class="col-12 text-center">
                                                                <a ng-click="postContChangeClick('{{ $user['usr']->pass }}', '{{ $user['usr']->id_administradores }}');" style="width: 200px;" href="#" class="btn btn-primary btn-block waves-effect waves-themed">Modificar</a>
                                                            </div>
                                                        </div>
