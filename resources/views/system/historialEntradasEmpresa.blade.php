...
-->
@section('menuActive','historialEntradasYSalidasPorEmpresa')
...
@section('controller','historialEntradasYSalidasPorEmpresa')
        ...
        <script>
            $( document ).ready(function() {
                ...
                $('#datepicker-2').change(function(){
                    ...
                    getHistorialEntradasByIdEmpresas("{{ $user['usr']->id_empresas }}", start, end);
