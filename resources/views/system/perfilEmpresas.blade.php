...
@section('raiz3','PerfilEmpresas')
@section('raiz3Url','/perfilEmpresas')


{{-- Angular Controller --}}

@section('controller','perfilEmpresas')
                                                                ...
                                                                <div class="col-md-4 text-center">
                                                                    ...
                                                                    <form method="post" action="{{ url('/api/empresas/profile/image') }}" enctype="multipart/form-data" id="FrmProfilePicture">
                                                                        ...
                                                                        <label for="profileimg" class="figure">
                                                                            ...
                                                                            <img class="profile-image  rounded-circle" onerror="this.src='{{ url('img/logo-example.png') }}'" style="width: 120px; height: 120px;" src="{{ url('img/logo-example.png') }}" alt="{{ $user['usr']->nombre_empresa }}" id="userProfilePicture">
                                                                        </label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 20px;" class="col-md-4">
                                                                    ...
                                                                    @isset($user["usr"]->nombre_empresa)
                                                                        {{ $user["usr"]->nombre_empresa }}
                                                                    @endisset

                                                                    @empty($user["usr"]->nombre_empresa)
                                                                        No especificado
                                                                    @endempty
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 20px;" class="col-md-4">
                                                                    ...
                                                                    @isset($user["usr"]->nombre_solicitante)
                                                                        {{ $user["usr"]->nombre_solicitante }}
                                                                    @endisset

                                                                    @empty($user["usr"]->nombre_solicitante)
                                                                        No especificado
                                                                    @endempty
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 20px;" class="col-md-4">
                                                                    ...
                                                                    @isset($user["usr"]->vigencia)
                                                                        {{ $user["usr"]->vigencia }}
                                                                    @endisset

                                                                    @empty($user["usr"]->vigencia)
                                                                        No especificado
                                                                    @endempty
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 20px;" class="col-md-4">
                                                                    ...
                                                                    @isset($user["usr"]->empleados_permitidos)
                                                                        {{ $user["usr"]->empleados_permitidos }}
                                                                    @endisset

                                                                    @empty($user["usr"]->empleados_permitidos)
                                                                        No especificado
                                                                    @endempty
