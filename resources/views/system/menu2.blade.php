                    <header class="page-header" role="banner">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            @if (in_array("2", $user["permisos"]))
                                ...
                                <div>
                                    <a href="#" data-toggle="dropdown" title="{{ $user['usr']->correo }}" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                        <img onerror="this.src='{{ url('img/profile-image.png') }}'" src="{{ url('img/profile-image.png') }}" class="profile-image rounded-circle" alt='{{ $user["usr"]->nombre_empresa }}'>
                                        <!-- you can also add username next to the avatar with the codes below:
                                        <span class="ml-1 mr-1 text-truncate text-truncate-header hidden-xs-down">Me</span>
                                        <i class="ni ni-chevron-down hidden-xs-down"></i> -->
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                        <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                            <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                                <span class="mr-2">
                                                    <img src="{{ url('img/avatar-admin.png') }}" class="rounded-circle profile-image" alt='{{ $user["usr"]->nombre_empresa }}'>
                                                </span>
                                                <div class="info-card-text">
