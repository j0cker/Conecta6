                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-chart-area"></i> {!! Lang::get('messages.textoTrabajadoresInicioTitle') !!}
                                <small>
                                </small>
                            </h1>
                            <div class="subheader-block d-lg-flex align-items-center">
                                <div class="d-inline-flex flex-column justify-content-center mr-3">
                                    <span class="fw-300 fs-xs d-block opacity-50">
                                        <small>{{ Lang::get('messages.textoTrabajadoresInicioTotalEntradas') }}</small>
                                    </span>
                            ...
                            <div class="subheader-block d-lg-flex align-items-center border-faded border-right-0 border-top-0 border-bottom-0 ml-3 pl-3">
                                <div class="d-inline-flex flex-column justify-content-center mr-3">
                                    <span class="fw-300 fs-xs d-block opacity-50">
                                        <small>{{ Lang::get('messages.textoTrabajadoresInicioTotalSalidas') }}</small>
                                    </span>
                            ...
                            <div class="col-lg-12 sortable-grid ui-sortable">
                                <div id="panel-4" class="panel data-panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                    <div class="panel-hdr" role="heading">
                                        <h2>
                                            {{ Lang::get('messages.textoTrabajadoresInicioResumenDelMesActual') }}  <span style="padding-left: 5px;" id="mesActual"></span>
                                        </h2>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                                <thead class="bg-warning-200">
                                                    <tr>
                                                        <th>{{ Lang::get('messages.textoTrabajadoresInicioPeriodo') }}</th>
                                                        <th>{{ Lang::get('messages.textoTrabajadoresInicioHorasTrabajadas') }}</th>
                                                        <th>{{ Lang::get('messages.textoTrabajadoresInicioHorasExtras') }}</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="historialTable">
                                                    <tr>
                                                        <th>{{ Lang::get('messages.textoTrabajadoresInicioDiario') }}</th>
                                                        <th></th>
                                                        <th></th>
                                                    </tr>
                                                    <tr>
                                                        <th>{{ Lang::get('messages.textoTrabajadoresInicioSemanal') }}</th>
                                                        <th></th>
                                                        <th></th>
                                                    </tr>
                                                    <tr>
                                                        <th>{{ Lang::get('messages.textoTrabajadoresInicioMensual') }}</th>
                                                        <th></th>
                                                        <th></th>
                                                    </tr>
                                                </tbody>
                                ...
                                <div id="panel-1" class="panel panel-locked panel-sortable" role="widget">
                                    <div class="panel-hdr" role="heading">
                                        <h2 class="ui-sortable-handle">
                                            {{ Lang::get('messages.textoTrabajadoresInicioEstadisticaDeTuTrabajo') }}
                                        </h2>
                                        <div class="panel-saving mr-2" style="display:none"><i class="fal fa-spinner-third fa-spin-4x fs-xl"></i></div><div class="panel-toolbar" role="menu">
                                            <a href="#" class="btn btn-panel hover-effect-dot js-panel-collapse waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Collapse"></a> 
                                            <a href="#" class="btn btn-panel hover-effect-dot js-panel-fullscreen waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Fullscreen"></a>
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-7 col-xl-8">
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="text-align: center;" id="no-updating-chart">{{ Lang::get('messages.textoTrabajadoresInicioNoHayDatos') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-5 col-xl-4 pl-lg-3">
                                                    <div class="d-flex mt-2">
                                                        {{ Lang::get('messages.textoTrabajadoresInicioTotalDeEntradasYSalidas') }}
                                                    ...
                                                    <div class="d-flex">
                                                        {{ Lang::get('messages.textoTrabajadoresInicioTotalEntradas2') }}
                                                    ...
                                                    <div class="d-flex">
                                                        {{ Lang::get('messages.textoTrabajadoresInicioTotalSalidas2') }}
                                                    ...
                                                    <div class="d-flex">
                                                        {{ Lang::get('messages.textoTrabajadoresInicioTotalEntradasEfectivas') }}
                                                    ...
                                                    <div class="d-flex">
                                                        {{ Lang::get('messages.textoTrabajadoresInicioTotalSalidasEfectivas') }}
                                                        <span class="d-inline-block ml-auto"><% entradasYSalidasEfectivas %></span>
                                                    </div>
                                                    <div class="progress progress-sm mb-3">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                                        <div class="px-3 py-2 d-flex align-items-center">
                                                            ...
                                                            <span class="d-inline-block ml-2 text-muted">
                                                                {{ Lang::get('messages.textoTrabajadoresInicioEntradas') }}
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                                        <div class="px-3 py-2 d-flex align-items-center">
                                                            ...
                                                            <span class="d-inline-block ml-2 text-muted">
                                                                {{ Lang::get('messages.textoTrabajadoresInicioSalidas') }}
                                                                <i class="fal fa-caret-up color-danger-500 ml-1"></i>
                                                            </span>
                                                            <div class="ml-auto d-inline-flex align-items-center">
                                                                <div class="sparklines totalEntradaYSalidas d-inline-flex" sparktype="line" sparkheight="30" sparkwidth="70" sparklinecolor="#886ab5" sparkfillcolor="false" sparklinewidth="1" values="5,6,5,3,8,6,9,7,4,2"><canvas width="70" height="30" style="display: inline-block; width: 70px; height: 30px; vertical-align: top;"></canvas></div>
