        ...
        <aside class="page-sidebar">
            ...
            <nav id="js-primary-nav" style="box-shadow: none !important;" class="primary-nav" role="navigation">
                ...
                <div class="info-card">
                    ...
                    <img src="img/cover-2-lg.png" class="cover" alt="cover">
                ...
                <ul id="js-nav-menu" class="nav-menu">
                                ...
                                @else
                                    <li class="">
                                @endif
                                        <a href="/inicio" title="Analytics Dashboard" data-filter-tags="application intel analytics dashboard">
                                ...
                                @else
                                    <li class="">
                                @endif
                                        <a href="/marketing" title="Marketing Dashboard" data-filter-tags="application intel marketing dashboard">
                                ...
                                @else
                                    <li class="">
                                @endif
                                        <a href="/introduction" title="Introduction" data-filter-tags="application intel introduction">
                            ...
                            <li class="nav-title">Others</li>
                                    <li>
                                        <a href="#" ng-click="logout()" title="Chat" data-filter-tags="pages chat">
                                            <span class="nav-link-text" data-i18n="nav.pages_chat">Logout</span>
                                        </a>
                                    </li>
                            </li>
