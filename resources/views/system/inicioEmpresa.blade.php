...
-->
@section('menuActive','inicioEmpresa')

@section('raiz1', @Config::get('app.name'))
@section('raiz1Url', '/inicioEmpresa')
@section('raiz2','Empresas')
@section('raiz2Url','/inicioEmpresa')
@section('raiz3','Inicio')
@section('raiz3Url','/inicioEmpresa')

{{-- Angular Controller --}}

@section('controller','inicioEmpresa')
...
@section('content')
        ...
        <script>
            $(document).ready(function()
            {
                ...
                getTrabajadoresByIdEmpresaClick("{{ $user['usr']->id_empresas }}");
                getAllEntradasSalidasByEmpresasClick("{{ $user['usr']->id_empresas }}");
            });
        </script>
