              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <div class="col-md-8 resaltar">
                    ...
                    <p class="resaltar">{{ Lang::get('messages.TextoEmpresasLoginBienvenida', ['nombre' => $nombre]) }}</p>

                    <div class="input-group resaltar">
                      <span class="input-group-addon "><span class="fa fa-user"></span></span>
                      <input id="correo" type="text" placeholder="{{ Lang::get('messages.textoEmpresasLoginCorreoElectronico') }}" class="form-control bootstrap-normal-input" aria-label="Amount (to the nearest dollar)">
                    </div>

                    <div class="input-group resaltar">
                      <span class="input-group-addon"><span class="fa fa-lock"></span></span>
                      <input id="contPass" type="password" placeholder="{{ Lang::get('messages.textoEmpresasLoginContrasena') }}" class="form-control bootstrap-normal-input" aria-label="Amount (to the nearest dollar)">
                    ...
                    <button ng-click="send()" id="ingresarButton" style="margin-top: 40px; margin-bottom: 40px;" class="btn waves-effect waves-light resaltar" type="submit" name="action">{{ Lang::get('messages.textoEmpresasLoginIngresar') }}
                      <i class="fa fa-sign-in" aria-hidden="true"></i>
                    </button>

                    <a style="margin-bottom: 40px;">
                      <p class="resaltar"><a href="{{ url('/'.$subdominio.'/recuperar') }}">{{ Lang::get('messages.textoEmpresasLoginOlvidaste') }}</a></p>
                    </a>
