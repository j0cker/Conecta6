              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <div class="col-md-8 resaltar">
                    ...
                    <p class="resaltar">{{ Lang::get('messages.textoTrabajadoresOlvidasteBienvenida') }}</p>

                    <div class="input-group resaltar">
                      <span class="input-group-addon "><span class="fa fa-user"></span></span>
                      <input id="correo" type="text" placeholder="{{ Lang::get('messages.textoTrabajadoresOlvidasteCorreoElectronico') }}" class="form-control bootstrap-normal-input" aria-label="Amount (to the nearest dollar)">
                    </div>

                    <button ng-click="postRecuperarClick()" id="ingresarButton" style="margin-top: 40px; margin-bottom: 40px;" class="btn waves-effect waves-light resaltar" type="submit" name="action">{{ Lang::get('messages.textoTrabajadoresOlvidasteRecuperar') }}
                      <i class="fa fa-sign-in" aria-hidden="true"></i>
                    </button>

                    <a style="margin-bottom: 40px;" href="#">
                      <p class="resaltar"><a href="{{ url('/'.$subdominio.'/') }}">{{ Lang::get('messages.textoTrabajadoresOlvidasteIniciarSesion') }}</a></p>
                    </a>
