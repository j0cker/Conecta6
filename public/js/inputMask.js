...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    return modules = [ function(module) {
        ...
        function importAttributeOptions(npt, opts, userOptions, dataAttribute) {
            ...
            return $.extend(!0, opts, userOptions), "rtl" !== npt.dir && !opts.rightAlign || (npt.style.textAlign = "left"), 
        ...
        Inputmask.extendAliases({
            numeric: {
                ...
                //inputmode: "numeric", //delimita el teclado del mobile coméntalo y no pasará
                shortcuts: {
                    k: "000",
                    m: "000000"
                },
            ...
            currency2: {
                prefix: "",
                alias: "numeric", //type Muneric
                groupSeparator: ",",
                digits: 6,
                radixPoint: "."
            },
            currency: {
                prefix: "$ ", //prefijo en el placeholder
                groupSeparator: ",", //sepra montos en miles
                alias: "numeric", //type Muneric
                digits: 2, //decimales
                digitsOptional: !1 //muestra dígitos como placeholders
            },
            decimal: {
                alias: "numeric"
            },
