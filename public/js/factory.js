(function() {
  app.factory('functions', function($http, $window) {
    return {
      ...
      modEmpresa: function(id_empresas, nombreEmpresa, nombreSolicitante, correoElectronico, telefonoFijo, celular, datepicker, empleadosPermitidos, activa, dominio, subdominio, tmpPass, contrasena, color) {

        console.log("[factory][modEmpresa]");

        var url = '/api/empresas/modEmpresa';
		  	return $http.post(url, {cache: false, id_empresas:id_empresas, nombreEmpresa:nombreEmpresa, nombreSolicitante:nombreSolicitante, correoElectronico:correoElectronico, telefonoFijo:telefonoFijo, celular:celular, datepicker:datepicker, empleadosPermitidos:empleadosPermitidos, activa:activa, dominio:dominio, subdominio:subdominio, tmpPass:tmpPass, contrasena:contrasena, color:color });
      ...
      eliminarEmpresa: function(id_empresa){
        ...
        var url = '/api/empresas/eliminar';
		  	return $http.post(url, {cache: false, id_empresa:id_empresa });
