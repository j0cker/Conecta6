...
<?php $__env->startSection('raiz3','Idiomas Agregar'); ?>
<?php $__env->startSection('raiz3Url','/idiomas/agregar'); ?>



<?php $__env->startSection('controller','modIdioma'); ?>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-door-open"></i> Modificar Idioma
                                <small>
                                </small>
                            </h1>
                        </div>
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 25px;" class="row">
                                                            ...
                                                            <div class="col-md-2"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-8">
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-2"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-8">
                                                                    ...
                                                                    <input id="nombreIdioma" type="text" class="form-control" placeholder="Nombre del Idioma" />
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-2"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-8">
                                                                    ...
                                                                    <input readonly="readonly" style="text-transform: lowercase;" id="codigo" type="text" class="form-control" placeholder="Código del Idioma ejemplo: fr, sz, de" />
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-2"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-8">
                                                                    ...
                                                                    <textarea style="width: 100%; height: 500px; border-radius: 10px; font-size: 14px;" id="contenido"></textarea>
