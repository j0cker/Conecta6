  ...
  <?php $__env->startSection('controller','recuperarAdministradores'); ?>
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <div class="card-image resaltar">
                  <img onerror="this.src='<?php echo e(url('img/logo-example.png')); ?>'" style="width: 240px !important; height: 101px !important;" class="profile-image logoCompany text-center" src="<?php echo e(url('img/Conecta6-logotipo.png')); ?>">
                </div>
