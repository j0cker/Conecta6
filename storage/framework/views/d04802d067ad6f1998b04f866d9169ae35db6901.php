              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <div class="col-md-8 resaltar">
                    ...
                    <p class="resaltar"><?php echo e(Lang::get('messages.textoEmpresasOlvidasteBienvenida')); ?></p>

                    <div class="input-group resaltar">
                      <span class="input-group-addon "><span class="fa fa-user"></span></span>
                      <input id="correo" type="text" placeholder="<?php echo e(Lang::get('messages.textoEmpresasOlvidasteCorreoElectronico')); ?>" class="form-control bootstrap-normal-input" aria-label="Amount (to the nearest dollar)">
                    </div>

                    <button ng-click="postRecuperarClick()" id="ingresarButton" style="margin-top: 40px; margin-bottom: 40px;" class="btn waves-effect waves-light resaltar" type="submit" name="action"><?php echo e(Lang::get('messages.textoEmpresasOlvidasteRecuperar')); ?>

                      <i class="fa fa-sign-in" aria-hidden="true"></i>
                    </button>

                    <a style="margin-bottom: 40px;" href="#">
                      <p class="resaltar"><a href="<?php echo e(url('/'.$subdominio.'/pAdmin')); ?>"><?php echo e(Lang::get('messages.textoEmpresasOlvidasteIniciarSesion')); ?></a></p>
                    </a>
