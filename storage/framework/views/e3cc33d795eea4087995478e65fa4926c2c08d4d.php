...
<?php $__env->startSection('raiz3Url','/perfilAdministradores/pass'); ?>




<?php $__env->startSection('controller','perfilAdministradoresPass'); ?>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fal fa-key"></i> Modificar Contraseña
                                <small>
                                </small>
                            </h1>
                        </div>
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 25px; margin-bottom: 25px;" class="row text-center">
                                                            <div class="col-12 text-center">
                                                                <a ng-click="postContChangeClick('<?php echo e($user['usr']->pass); ?>', '<?php echo e($user['usr']->id_administradores); ?>');" style="width: 200px;" href="#" class="btn btn-primary btn-block waves-effect waves-themed">Modificar</a>
                                                            </div>
                                                        </div>
