...
<?php $__env->startSection('controller','nuevoIdioma'); ?>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-door-open"></i> Nuevo Idioma
                                <small>
                                </small>
                            </h1>
                        </div>
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="font-size: 25px; color: black;" class="col-md-4">
                                                                    ...
                                                                    <input style="text-transform: lowercase;" id="codigo" type="text" class="form-control" placeholder="Código del Idioma ejemplo: fr, sz, de" />
                                                        ...
                                                        <div style="margin-top: 25px; margin-bottom: 25px;" class="row text-center">
                                                            <div class="col-12 text-center">
                                                                <a ng-click="agregarIdiomaClick()" style="width: 200px;" href="#" class="btn btn-primary btn-block waves-effect waves-themed">Agregar</a>
                                                            </div>
                                                        </div>
