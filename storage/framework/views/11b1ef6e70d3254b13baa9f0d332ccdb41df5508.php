                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-history'></i> <?php echo Lang::get('messages.textoTrabajadoresHistorialTitle'); ?>
                            ...
                            <div class="col-lg-12 sortable-grid ui-sortable">
                                <div id="panel-4" class="panel data-panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                    <div class="panel-hdr" role="heading">
                                        <h2>
                                            <?php echo e(Lang::get('messages.textoTrabajadoresHistorialHistorial')); ?>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                                <thead class="bg-warning-200">
                                                    <tr>
                                                        <th><?php echo e(Lang::get('messages.textoTrabajadoresHistorialID')); ?></th>
                                                        <th><?php echo e(Lang::get('messages.textoTrabajadoresHistorialFechaYHora')); ?></th>
                                                        <th><?php echo e(Lang::get('messages.textoTrabajadoresHistorialEntradaSalida')); ?></th>
                                                        <th><?php echo e(Lang::get('messages.textoTrabajadoresHistorialComentarios')); ?></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(Lang::get('messages.textoTrabajadoresHistorialFechaYHora')); ?></th>
                                                        <th><?php echo e(Lang::get('messages.textoTrabajadoresHistorialEntradaSalida')); ?></th>
                                                        <td><?php echo e(Lang::get('messages.textoTrabajadoresHistorialComentarios')); ?></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                            <!-- datatable end -->
