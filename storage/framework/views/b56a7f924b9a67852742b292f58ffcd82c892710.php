            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <div style="margin-top: 35px; width: 270px !important; height: 121px !important;" class="card-image resaltar">
                  <img onerror="this.src='<?php echo e(url('img/logo-example.png')); ?>'" style="width: 240px !important; height: 101px !important;" class="logoCompany text-center" src="<?php echo e(url('img/Conecta6-logotipo.png')); ?>">
                </div>
