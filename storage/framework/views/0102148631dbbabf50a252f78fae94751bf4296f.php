                                    ...
                                    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                        <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                            <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                                <span class="mr-2">
                                                    <img onerror="this.src='<?php echo e(url('img/profile-image.png')); ?>'" src="<?php echo e(url('img/profile-image.png')); ?>" class="rounded-circle profile-image" alt='<?php echo e($user["usr"]->nombre); ?> <?php echo e($user["usr"]->apellido); ?>'>
                                                </span>
                            ...
                            <?php if(in_array("2", $user["permisos"])): ?>
                                ...
                                <div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                        ...
                                        <div class="dropdown-divider m-0"></div>
                                        <a href="<?php echo e(url('/perfilEmpresas')); ?>" class="dropdown-item">
                            ...
                            <?php if(in_array("1", $user["permisos"])): ?>
                                ...
                                <div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                        ...
                                        <div class="dropdown-divider m-0"></div>
                                        <a href="<?php echo e(url('/perfilAdministradores')); ?>" class="dropdown-item">
                                            <span data-i18n="drpdwn.reset_layout">Ir al perfil</span>
                                        </a>
                                        <div class="dropdown-divider m-0"></div>
                                        <a ng-click="logout()" class="dropdown-item fw-500 pt-3 pb-3" href="#">
