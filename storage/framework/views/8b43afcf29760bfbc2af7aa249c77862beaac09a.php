...
-->
<?php $__env->startSection('menuActive','empresas'); ?>
...
<?php $__env->startSection('raiz2Url','/empresas'); ?>
<?php $__env->startSection('raiz3','Modificar Empresa'); ?>
<?php $__env->startSection('raiz3Url','/modificar'); ?>



<?php $__env->startSection('controller','modempresa'); ?>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-building"></i> Modificar Empresa
                                <small>
                                </small>
                            </h1>
                        </div>
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div style="margin-top: 10px; !important" class="input-group">
                                                                    <input type="text" class="form-control" placeholder="Vigencia" id="datepicker">
                                                        ...
                                                        <div style="margin-top: 10px;" class="row">
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                ...
                                                                <div class="custom-control custom-switch mr-2 col-md-4 text-center">
                                                                    <input type="checkbox" class="custom-control-input" name="gra-0" id="gra-0" checked="checked">
                                                                    <label class="custom-control-label" for="gra-0"></label>
                                                                </div>
                                                                    ...
                                                                    <div class="settings-panel">
                                                                        ...
                                                                        <div class="expanded theme-colors pl-5 pr-3">
                                                                            <ul class="m-0">
                                                                                ...
                                                                                <li><a ng-click="color(1);" name="myapp-1" href="#" id="myapp-1" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-1.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tapestry"></a></li>
                                                                                <li><a ng-click="color(2);" href="#" id="myapp-2" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-2.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Atlantis"></a></li>
                                                                                <li><a ng-click="color(3);" href="#" id="myapp-3" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-3.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Indigo"></a></li>
                                                                                <li><a ng-click="color(4);" href="#" id="myapp-4" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-4.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Dodger Blue"></a></li>
                                                                                <li><a ng-click="color(5);" href="#" id="myapp-5" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-5.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tradewind"></a></li>
                                                                                <li><a ng-click="color(6);" href="#" id="myapp-6" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-6.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cranberry"></a></li>
                                                                            </ul>
                                                                        </div> 
                                                                        <div class="expanded theme-colors pl-5 pr-3">
                                                                            <ul class="m-0">
                                                                                <li><a ng-click="color(7);" href="#" id="myapp-7" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-7.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Oslo Gray"></a></li>
                                                                                <li><a ng-click="color(8);" href="#" id="myapp-8" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-8.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Chetwode Blue"></a></li>
                                                                                <li><a ng-click="color(9);" href="#" id="myapp-9" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-9.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Apricot"></a></li>
                                                                                <li><a ng-click="color(10);" href="#" id="myapp-10" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-10.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Blue Smoke"></a></li>
                                                                                <li><a ng-click="color(11);" href="#" id="myapp-11" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-11.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Green Smoke"></a></li>
                                                                                <li><a ng-click="color(12);" href="#" id="myapp-12" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-12.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wild Blue Yonder"></a></li>
                                                                                <li><a ng-click="color(13);" href="#" id="myapp-13" data-action="theme-update" data-themesave="" data-theme="<?php echo e(url('css/themes/cust-theme-13.css')); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Emerald"></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
