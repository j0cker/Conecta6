                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-user"></i> <?php echo e(Lang::get('messages.textoEmpresasTrabajadoresModificarTrabajador')); ?>
                                ...
                                <div id="panel-1" class="panel panel-locked panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                    ...
                                    <div class="panel-hdr">
                                        <h2 class="ui-sortable-handle">
                                            <?php echo e(Lang::get('messages.textoEmpresasTrabajadoresModificarTrabajador')); ?>
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="position-relative">
                                                        ...
                                                        <div style="margin-top: 25px; margin-bottom: 25px;" class="row text-center">
                                                            <div class="col-12 text-center">
                                                                <a style="width: 200px;" href="#" ng-click="modTrabajadorClick('<?PHP echo $_GET['id_trabajadores']; ?>', '<?php echo e($user['usr']->id_empresas); ?>');" class="btn btn-primary btn-block waves-effect waves-themed"><?php echo e(Lang::get('messages.textoEmpresasTrabajadoresModificar')); ?></a>
                                                            </div>
                                                        </div>
